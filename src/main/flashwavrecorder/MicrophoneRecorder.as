...
public class MicrophoneRecorder extends EventDispatcher {
    ...
    public function convertToPCM(name:String):ByteArray {
        return MicrophoneRecorder.convertToPCM(this.getSoundBytes(name));
    }

    public static function convertToPCM(soundBytes:ByteArray):ByteArray {
